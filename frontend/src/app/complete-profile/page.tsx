...
/**
 * PHASE 1 & 2 - Profile Completion Page
 * 
 * Shown after email verification to complete MongoDB registration.
 * User selects role (Buyer/Seller) and fills profile details.
 * 
 * - Buyer: Basic profile fields only
 * - Seller: Profile fields + GST number (required)
 */
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const profileData: ProfileCompleteData = {
        ...
        ...(selectedRole === 'seller' && { gstNumber: formData.gstNumber }),
      };
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center gap-2 mt-4">
              <div className={`w-3 h-3 rounded-full ${step === 'role' ? 'bg-blue-600' : 'bg-green-500'}`} />
              <div className="w-8 h-0.5 bg-gray-300">
                <div className={`h-full transition-all ${step === 'profile' ? 'bg-blue-600 w-full' : 'w-0'}`} />
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                      Browse products, send inquiries, and connect with verified sellers
                    </p>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">
                      List your products, receive inquiries, and grow your business
                    </p>
              ...
              {selectedRole === 'seller' && (
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Your GST will be verified. You can create draft listings while verification is pending.
                  </p>
                </div>
              )}
