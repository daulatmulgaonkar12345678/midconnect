...
async function fetchAPI(endpoint, options = {}) {
    ...
    if (!API_URL) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"]('API URL not configured', 500, 'CONFIG_ERROR');
    }
...
function AuthProvider({ children }) {
    ...
    const completeRegistrationHandler = async (profileData)=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["completeProfile"])(token, profileData);
            setState((prev)=>({
                    ...prev,
                    user: state.user,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1bb265f8._.js.map